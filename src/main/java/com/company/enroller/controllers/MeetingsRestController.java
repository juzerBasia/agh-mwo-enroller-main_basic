...
/////////////////////
//	@RequestMapping(value = "/{id}/participantLogin}", method = RequestMethod.PUT)
//	public ResponseEntity<?> addPartToMeet(@PathVariable("id") long id, @RequestBody Participant participantLogin){
//
//		Meeting foundMeeting = meetingService.findByID(id);
//		if (foundMeeting == null) {
//			return new ResponseEntity<>("Not found", HttpStatus.NOT_FOUND);
...
//
//		foundMeeting.addParticipant(participantLogin);
//
//		meetingService.update(foundMeeting);
//		return new ResponseEntity<Meeting>(foundMeeting, HttpStatus.OK);
//	}
